...
printUsage() {
    ...
    echo "Example: "
    echo "      $0 -q QM1 -d /opt/mqm/bin -u root  -l INSTANA.ACE.LST -c INSTANA.ACE.SVRCONN -t INSTANA.ACE.BROKER.TOPIC"
    echo "      $0 -q QM1 -d /opt/mqm/bin -u root  -p 'connect'       -c INSTANA.ACE.SVRCONN -t INSTANA.ACE.BROKER.TOPIC" 
    echo "      $0 -q QM1 -d /opt/mqm/bin -u root  -p 'connect inq'   -l INSTANA.ACE.LST -c INSTANA.ACE.SVRCONN"
    echo "      $0 -q QM1 -d /opt/mqm/bin -c INSTANA.ACE.SVRCONN"
    echo ""
    echo "Arguments:"
